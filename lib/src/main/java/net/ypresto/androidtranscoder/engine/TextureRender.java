...
class TextureRender {
  ...
  public static final String FRAGMENT_SHADER_FOR_BITMAP =
    "precision mediump float;\n" +
      "varying vec2 vTextureCoord;\n" +
  ...
  private int mBitmapProgram;
  private int mBitmapTextureID = -12345;
  private int mBitmapuMVPMatrixHandle;
  private int mBitmapuSTMatrixHandle;
  private int mBitmapaPositionHandle;
  private int mBitmapaTextureHandle;
  ...
  public void drawFrame(SurfaceTexture st) {
    ...
    checkGlError("glUseProgram mBitmapProgram");
    GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mBitmapTextureID);
    mTriangleVertices.position(TRIANGLE_VERTICES_DATA_POS_OFFSET);
    GLES20.glVertexAttribPointer(mBitmapaPositionHandle, 3, GLES20.GL_FLOAT, false,
      TRIANGLE_VERTICES_DATA_STRIDE_BYTES, mTriangleVertices);
    checkGlError("glVertexAttribPointer mBitmapaPositionHandle");
    GLES20.glEnableVertexAttribArray(mBitmapaPositionHandle);
    checkGlError("glEnableVertexAttribArray mBitmapaPositionHandle");
    mTriangleVertices.position(TRIANGLE_VERTICES_DATA_UV_OFFSET);
    GLES20.glVertexAttribPointer(mBitmapaTextureHandle, 2, GLES20.GL_FLOAT, false,
      TRIANGLE_VERTICES_DATA_STRIDE_BYTES, mTriangleVertices);
    checkGlError("glVertexAttribPointer mBitmapaTextureHandle");
    GLES20.glEnableVertexAttribArray(mBitmapaTextureHandle);
    checkGlError("glEnableVertexAttribArray mBitmapaTextureHandle");
    Matrix.setIdentityM(mMVPMatrix, 0);
    Matrix.translateM(mMVPMatrix, 0, -0.5f, -0.5f, 0f);
    Matrix.scaleM(mMVPMatrix, 0, 0.5f, 0.5f, 0.5f);
    GLES20.glUniformMatrix4fv(mBitmapuMVPMatrixHandle, 1, false, mMVPMatrix, 0);
    GLES20.glUniformMatrix4fv(mBitmapuSTMatrixHandle, 1, false, mSTMatrix, 0);
  ...
  private void initBitmapProgram() {
    mBitmapProgram = createProgram(VERTEX_SHADER, FRAGMENT_SHADER_FOR_BITMAP);
    if (mProgram == 0) {
      throw new RuntimeException("failed creating program");
    }
  ...
  private void initVideoTexture() {
    ...
    GLES20.glTexParameteri(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, GLES20.GL_TEXTURE_WRAP_T,
      GLES20.GL_CLAMP_TO_EDGE);
    checkGlError("glTexParameter mTextureID");
  }

  private void initBitmapTexture() {
//    GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mBitmapTextureID);
//    checkGlError("glBindTexture mBitmapTextureId");
//
//    GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);
//    GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR);
//    GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S, GLES20.GL_CLAMP_TO_EDGE);
//    GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_T, GLES20.GL_CLAMP_TO_EDGE);
//    checkGlError("glTexParameter mBitmapTextureId");
//
//    GLES20.glEnable(GLES20.GL_BLEND);
//    GLES20.glBlendFunc(GLES20.GL_SRC_ALPHA, GLES20.GL_ONE_MINUS_SRC_ALPHA);
//
//    final Bitmap bitmap = BitmapHolder.getInstance().getBitmap();
